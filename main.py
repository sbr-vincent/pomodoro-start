...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        label.config(text="BREAK", fg=RED, font=(FONT_NAME, 35, "bold"))
    elif reps % 2 == 0:
        count_down(short_break_sec)
        label.config(text="BREAK", fg=PINK, font=(FONT_NAME, 35, "bold"))
    else:
        count_down(work_sec)
        label.config(text="WORK", fg=GREEN, font=(FONT_NAME, 35, "bold"))
